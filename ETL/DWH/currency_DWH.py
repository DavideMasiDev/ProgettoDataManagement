...
def load_records():
    ...
    query = 'select distinct currency as currency_code from "STAGING".price_history where currency is not null'
    ...
    currency_name = {"EUR": "Euro", "USD": "Dollaro Statunitense", "GBP": "Sterlina Britannica", "CHF": "Franco Svizzero"}
